        ...
        <div class="col-lg-12 col-md-12 col-sm-12 mb-4">
            <div class="row">
                <div class="col-sm-3 mb-5">
                    <div class="card">
                        <img src="../assets/images/feed-image-1.png" class="card-img-top" alt="...">
                        <div class="card-body">
                ...
                <div class="col-sm-3 mb-5">
                    <div class="card">
                        <img src="../assets/images/feed-image-2.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                                additional
                ...
                <div class="col-sm-3 mb-5">
                    <div class="card">
                        <img src="../assets/images/feed-image-5.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to
                                additional
                ...
                <div class="col-sm-3 mb-5">
                    <div class="card">
                        <img src="../assets/images/feed-image-4.png" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Card title</h5>
